...
{
public:
    std::optional<int> create(const std::string &resource, const std::string &data) override;

    std::optional<std::string> retrieve(const std::string &resource, int id) const override;

    bool update(const std::string &resource, int id, const std::string &data) override;
